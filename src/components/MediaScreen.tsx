...
//         <p className="md:text-2xl text-lg font-bold mb-4 text-pocket-red">Pocket-FM</p>
...
export default function MediaScreen() {
  ...
  // Helper component to display the header content
  const Header = () => (
    <div className='flex flex-col items-center m-8'>
      <p className="text-2xl font-bold mb-4 text-pocket-red">Pocket-FM</p>
      <p className="text-xl">Audio/Video Player</p>
      <p className="text-sm">Upload a file or select from sample media</p>
    </div>
  );

  // Conditionally render the MediaPlayer or a placeholder
